...
<h3>Authorize.net Payment Gateway for WooCommerce</h3> allows you to accept credit cards directly on your WooCommerce store by utilizing the Authorize.net payment gateway.

= Features =

1. Accept Credit Cards directly on your website by using the Authorize.net gateway.
2. No redirecting your customer back and forth.
3. Very easy to install and configure. Ready in Minutes!
4. Customizable transaction success and failure messages.
5. Safe and secure method to process credit cards using the Authorize.net payment gateway.
