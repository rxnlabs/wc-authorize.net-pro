   ...
   */
   class WC_Tech_Authoaim extends WC_Payment_Gateway 
   {
      ...
      public function __construct(){
         ...
         $this->method_title     = __('Authorize.net', 'wc-tech-authoaim');
      ...
      function init_form_fields()
      {
         ...
         $this->form_fields = array(
            'enabled'      => array(
                  ...
                  'type'         => 'checkbox',
                  'label'        => __('Enable This Payment Module.', 'wc-tech-authoaim'),
                  'default'      => 'no'),
            'title'        => array(
            ...
            'description'  => array(
                  ...
                  'default'      => __('Pay securely by Credit or Debit Card through Authorize.net.', 'wc-tech-authoaim')),
            'login_id'     => array(
